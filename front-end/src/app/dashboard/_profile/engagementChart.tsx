...
import { ChartData } from '../../../../gql/graphql';
...
export const EngagementChart: React.FC<EngagementChartProps> = ({ chartData }) => {
  const { monthlyData, weeklyData } = chartData;
  const [mounted, setMounted] = useState(false);
  const [activeData, setActiveData] = useState<typeof weeklyData | typeof monthlyData>(weeklyData);
