  ...
  return (
    <div className="relative bg-[#0a0f1c]/40 backdrop-blur-xl rounded-xl p-4 mb-6
      ...
      <DialogHeader>
        ...
        {stories.map((story: { createdAt: string; imageURL: string | undefined; author: { name: string | number | bigint | boolean | React.ReactElement<unknown, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | Promise<string | number | bigint | boolean | React.ReactPortal | React.ReactElement<unknown, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | null | undefined> | null | undefined; profileImageURL: string; }; videoURL: string | undefined; }, index: number) => {
            ...
            <div className="relative cursor-pointer">
              <div className="w-28 h-40 rounded-xl overflow-hidden
                ...
                <div className="absolute top-3 left-3 ring-[3px] ring-blue-500 rounded-full
                              ...
                              group-hover:scale-110">
                  <UserAvatar src={story.author.profileImageURL} name={String(story.author.name ?? "")} size="sm" />
                </div>
