...
export const colorMapping: { [key: string]: string } = {
 ...
 export const borderMapping: { [key: string]: string } = {
  red: "border-red-500",
  "#119EE6": "border-[#119EE6]",
  "#23C55D": "border-[#23C55D]",
  "#EFC23B": "border-[#EFC23B]",
  purple: "border-purple-500",
  orange: "border-orange-500",
  "#EF476E": "border-[#EF476E]",
  gray: "border-gray-500",
  black: "border-black",
  white: "border-white",
 };
 export const backgroundMapping: { [key: string]: string } = {
  red: "bg-red-500",
  "#119EE6": "bg-[#119EE6]",
  "#23C55D": "bg-[#23C55D]",
  "#EFC23B": "bg-[#EFC23B]",
